from flask import Flask,json, jsonify, request, render_template, Response, session, redirect
...
app = Flask(__name__)
# Define a custom JSONEncoder class or use Flask's default JSONEncoder
